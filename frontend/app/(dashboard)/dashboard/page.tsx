                                                        ...
                                                        <div className="flex items-center justify-between gap-2">
                                                            ...
                                                            <div className="flex flex-col items-end gap-1.5">
                                                                ...
                                                                <Button
                                                                    ...
                                                                    className="h-6 px-2 text-[10px] font-bold text-indigo-600 bg-indigo-50/50 hover:bg-indigo-100 hover:text-indigo-700 border-indigo-200/60 rounded-md transition-all flex items-center gap-1 shadow-xs"
                                                                >
