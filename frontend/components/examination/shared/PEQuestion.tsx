...
interface PEQuestionProps {
    ...
    disabled?: boolean;
    compact?: boolean;
    activeColor?: "indigo" | "rose" | "cyan" | "emerald";
    hideValue?: boolean;
}
...
export const PEQuestion = React.memo(({
    ...
    const colors = {
        ...
        emerald: { bg: "bg-emerald-50/50", border: "border-emerald-100", text: "text-emerald-900", badge: "bg-emerald-100 text-emerald-700 border-emerald-200", activeRing: "ring-emerald-600/20", activeText: "text-emerald-700" }
    };
