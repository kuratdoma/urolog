...
import app.main  # Ensures full application model graph initialization
from app.db.session import SessionLocal
from app.models.user import User
from app.models.personal_note import PersonalNote, AssignmentStatus, NoteColor, RecurrenceType
